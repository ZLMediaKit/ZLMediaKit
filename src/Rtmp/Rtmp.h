...
// 增强型rtmp大端模式FourCC
static constexpr uint32_t fourcc_be_vp9 = htonl('vp09');
static constexpr uint32_t fourcc_be_av1 = htonl('av01');
static constexpr uint32_t fourcc_be_hevc = htonl('hvc1');
