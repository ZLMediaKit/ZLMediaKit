...
#define RELOAD_KEY(arg, key)                                                                                                     \
    do {                                                                                                                         \
        ...
        const_cast<typename std::remove_const<typename std::remove_reference<decltype(arg)>::type >::type &>(arg) = arg##_tmp;   \
