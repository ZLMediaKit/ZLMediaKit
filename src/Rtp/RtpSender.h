...
public:
     ...
     */
    void startSend(const std::string &dst_url, uint16_t dst_port, bool is_udp, uint16_t src_port, const std::function<void(uint16_t local_port, const SockException &ex)> &cb);
